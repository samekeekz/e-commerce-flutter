      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "This is a simple ecommerce application that provides you with a ready-made front-end template that can be run on all platforms such as (Mobile, Windows, Web). Coded by Samat Belentbay and Gani Uapov using Flutter framework while considering important concepts and features such as : \nResponsive and adaptive UI, \nReusable and organized code structure, \nDark and light theme.",
              style: GoogleFonts.lora(
                  fontSize:
                      (UniversalPlatform.isDesktop || UniversalPlatform.isWeb)
